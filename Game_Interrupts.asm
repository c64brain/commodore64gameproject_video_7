...
;===============================================================================
; CHARACTER SET GENERATOR ROM: 22 (Points to ScoreChars.cst character set)
; ScoreChars.cst starts at $5000
;===============================================================================
@start   
...
; Fixes issue with a screen being jumpy at the bottom display
