...
Setup_Map
        ...
        ldx #26                        ; Y start pos (in tile coords) (75,26=default)
        ldy #18                          ; X start pos (in tile coords)
...
incbin"Parkour_Maps/Parkour Mat Chset9g2.bin"
...
incbin "yoursprite.spt",43,44,true       ; Swimming to the right
incbin "yoursprite.spt",45,46,true       ; Swimming to the left
incbin "yoursprite.spt",47,89,true
incbin "yoursprite.spt",90,92,true   
incbin "yoursprite.spt",93,110,true
...
incbin"Parkour_Maps/Parkour Mat Map9g.bin"

ATTRIBUTE_MEM
;incbin"Parkour_Maps/Parkour Redo ChsetAttrib6.bin"
incbin"Parkour_Maps/Parkour Mat ChsetAttrib9g.bin"

TILE_MEM
;incbin"Parkour_Maps/Parkour Redo Tileset6.bin"
incbin"Parkour_Maps/Parkour Mat Tileset9g.bin"
